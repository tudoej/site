<div id="main">
	...
	<form id="create-listing" class="listing-categories renew-listing-categories" enctype="multipart/form-data" method="post" action="<?php echo $form_action; ?>">
		<?php wp_nonce_field( 'va_renew_listing_categories' ); ?>
		<input type="hidden" name="action" value="renew-listing-categories">
		...
		<?php do_action( 'va_after_renew_listing_categories_form' ); ?>
