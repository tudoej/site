		...
		<?php else: ?>
			...
			<div class="user-pass1-wrap manage-password">
				<div class="form-field">
					...
					<button type="button" class="button wp-hide-pw hide-if-no-js" data-start-masked="<?php echo (int) isset( $_POST['pass1'] ); ?>" data-toggle="0" aria-label="<?php esc_attr_e( 'Hide password', APP_TD ); ?>">
